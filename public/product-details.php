...
<div class="product-details">
	<div class="container info"> <!-- Husk basic-info media query ting-->
		<div class="col-xs-12 col-md-6">
			<div class="img-wrapper">
				<img src="img/shoe-big.jpg" alt="Image of a shoe">
			</div>
			<div class="gallery">
				<div class="img-wrapper">
					<img src="img/shoe-side.jpg" alt="Image of a shoe">
				</div>
				<div class="img-wrapper active">
					<img src="img/shoe-top.jpg" alt="Image of a shoe">
				</div>
				<div class="img-wrapper">
					<img src="img/shoe-front.jpg" alt="Image of a shoe">
				</div>
			</div>
		</div>
		<div class="col-xs-12 col-md-6 product-info">
			...
			<div class="info-wrapper">
				<div>
					<img src="img/asics-logo.jpg" alt="Asics logo">
				</div>
				<div class="price-info">
					<p class="price">kr. 974.90</p>
					<div class="discount">
						<p>kr 1115.24</p>
						<p>You save 15.00%</p>
					</div>
